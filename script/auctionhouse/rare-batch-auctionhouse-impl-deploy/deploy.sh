...
FORGE_CMD="forge script script/auctionhouse/rare-batch-auctionhouse-impl-deploy/RareBatchAuctionHouseImplDeploy.s.sol:RareBatchAuctionHouseImplDeploy --rpc-url ${RPC_URL} -vv"
