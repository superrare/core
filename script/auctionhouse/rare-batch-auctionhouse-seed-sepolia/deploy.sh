...
FORGE_CMD="forge script script/auctionhouse/rare-batch-auctionhouse-seed-sepolia/RareBatchAuctionHouseSeedSepolia.s.sol:RareBatchAuctionHouseSeedSepolia --rpc-url ${RPC_URL} -vv "
