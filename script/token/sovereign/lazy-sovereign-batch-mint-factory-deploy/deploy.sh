...
FORGE_CMD="forge script script/token/sovereign/lazy-sovereign-batch-mint-factory-deploy/LazySovereignBatchMintFactoryDeploy.s.sol:LazySovereignBatchMintFactoryDeploy --rpc-url ${RPC_URL} --via-ir  -vv"
