...
FORGE_CMD="forge script script/bazaar/bazaar-empty-staking-registry-update/BazaarEmptyStakingRegistryUpdate.s.sol:BazaarEmptyStakingRegistryUpdate --rpc-url ${RPC_URL} -vv"
