...
library NetworkConfig {
  ...
  function _ethereumSepolia() private pure returns (Addresses memory config) {
    ...
    config.erc1155ApprovalManager = _addr(0x4fAAaBbe326b1984A7B044d16C1d7ed900F3E60a);
    config.rareErc1155Settlement = _addr(0x8Ef8e53Efdf59d71dD50083fA756FBD44d3aD3ea);
    config.rareErc1155MarketplaceImplementation = _addr(0xb3B1E72173074ecF66c5EAdA96E4b738482BDbe6);
    config.rareErc1155MarketplaceProxy = _addr(0x99dc6369541c861c2DF1530103165Bbd3d21dD82);
    config.rareErc1155ContractFactory = _addr(0x3BB9bfDA06A2250Db74f1a7B88D8a9C5aC0e2e67);
    config.rareErc1155Implementation = _addr(0x39073fEdF84F0cAcA595e94423C82c6Eb35B06fd);
    config.rareErc1155ContractFactoryOwner = _addr(0x3B9C3C5EA16E7d3c9C0bb293a549aFa4066dc162);
    config.rareErc1155ContractFactoryDefaultMinter = _addr(0x99dc6369541c861c2DF1530103165Bbd3d21dD82);
