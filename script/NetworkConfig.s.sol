...
library NetworkConfig {
  ...
  function _ethereumSepolia() private pure returns (Addresses memory config) {
    ...
    config.rareErc1155Settlement = _addr(0xACF9874d609B63dEFd9e76f7AAAfe64917F35591);
    config.rareErc1155MarketplaceImplementation = _addr(0xD828415C588503B60CcE4d2d20838DbD01c0DbAE);
    config.rareErc1155MarketplaceProxy = _addr(0x92f80E8ED2D6ec5501069739Fb26405a31833a0b);
    config.rareErc1155ContractFactory = _addr(0xEa895C8D6C53AEe862Dbb65EE04Af80781B53a85);
    config.rareErc1155Implementation = _addr(0xbd4F2218bd8fF4A00a615547a338aBFda9cd2528);
    config.rareErc1155ContractFactoryOwner = _addr(0x3B9C3C5EA16E7d3c9C0bb293a549aFa4066dc162);
    config.rareErc1155ContractFactoryDefaultMinter = _addr(0x92f80E8ED2D6ec5501069739Fb26405a31833a0b);
