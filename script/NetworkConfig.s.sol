...
library NetworkConfig {
  ...
  function _ethereumSepolia() private pure returns (Addresses memory config) {
    ...
    config.erc1155ApprovalManager = _addr(0xcD26069837682aeD8Ba20852AD17b8f64a860906);
    config.rareErc1155TradeExecutionModule = _addr(0x2aF0Aa7E783079eB847348632D2F3c4D128bf140);
    ...
    config.rareErc1155ContractFactoryDefaultMinter = _addr(0xb26DE57230913a44F37AcE78F5b7eB2Efec474eE);
  ...
  function _baseMainnet() private pure returns (Addresses memory config) {
    ...
    config.rareErc1155TradeExecutionModule = _addr(0x104ae97A14E4C75058971E62Df7dd9993Ea759aD);
    config.rareErc1155CheckoutExecutionModule = _addr(0x5425759946F62BB367BA60F8219e0715f844C28e);
    config.rareErc1155MarketplaceImplementation = _addr(0xd795Ff84dc7FF32443406BcC31Fb8356D9cc9dC0);
  ...
  function _baseSepolia() private pure returns (Addresses memory config) {
    ...
    config.rareErc1155TradeExecutionModule = _addr(0x426734CB822bddCb6dbD03A60eb0A6CEdDa08849);
    config.rareErc1155CheckoutExecutionModule = _addr(0x11978b81493f972AF71CC95A518608F7C108A61f);
    config.rareErc1155MarketplaceImplementation = _addr(0x1527F9D7c14c4c46Ad25dCa04b3Ab2e03DebDa66);
