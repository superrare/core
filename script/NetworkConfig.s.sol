...
library NetworkConfig {
  ...
  function _ethereumSepolia() private pure returns (Addresses memory config) {
    ...
    config.rareErc1155CheckoutExecutionModule = _addr(0x8513256A682a1849051a139c26420bf713eae0bF);
    config.rareErc1155MarketplaceImplementation = _addr(0x154ca5088b07c6dF323D3E13ed48F2D8B3d082A7);
