...
contract SovereignNFTRoyaltyGuardDeadmanTriggerV2 is SovereignNFTV2, RoyaltyGuardDeadmanTrigger {
  /*//////////////////////////////////////////////////////////////////////////
                              ERC165 LOGIC
  //////////////////////////////////////////////////////////////////////////*/
  ...
  function supportsInterface(
    bytes4 _interfaceId
  ) public view virtual override(SovereignNFTV2, RoyaltyGuard) returns (bool) {
    return RoyaltyGuard.supportsInterface(_interfaceId) || SovereignNFTV2.supportsInterface(_interfaceId);
  }
